...
public:
    // buttons after LONGPRESS are reserved for touch handlers
	enum Button { BTN_NONE = 0, BTN_LEFT, BTN_RIGHT, BTN_CLICK, BTN_LONGPRESS, BTN_SWIPEUP, BTN_SWIPEDOWN, BTN_MENU };
